...
| 軸              | 重み | 実装状況                                                                                                                                                                                    |
| --------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| correctness     | 50   | ✅ compile 40% + test 40% + prop_test 20%（mutation 有効時: 30+30+15+mutation 25%）<br>mutation: Rust=`cargo-mutants`、Python=`mutmut`、Go=`gremlins`（各ツールが PATH になければ Skipped） |
